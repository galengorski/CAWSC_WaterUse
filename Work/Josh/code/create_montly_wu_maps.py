...
for ix, month in enumerate(months):
    for miles in miles_list:
        ...
        interp_shp = os.path.join(
            ...
            "output",
            "monthly",
            "2010_interp_{}_{}_mi.shp".format(month.split("_")[0], miles),
        )
        point_shp = os.path.join(
            ...
            "output",
            "monthly",
            "2010_point_{}_{}_mi.shp".format(month.split("_")[0], miles),
        )
        interp_fig = os.path.join(
            ...
            "output",
            "monthly",
            "2010_{}_{}m_interp.png".format(month.split("_")[0], miles),
        )
        point_fig = os.path.join(
            ...
            "output",
            "monthly",
            "2010_{}_{}m_1to1.png".format(month.split("_")[0], miles),
        )
        ...
        for val in sorted(df1.std_flg_1.unique()):
            ...
            color = cdict[val]
            ax = utl.plot_1_to_1(
                tdf, [month, "mean_1"], ax=ax, color=color, label=label
            )
        ...
        plt.ylabel(
            "{} mean 'neighborhood' water use, {} mile radius".format(
                month.split("_")[0], miles
            )
        )
        plt.legend()
