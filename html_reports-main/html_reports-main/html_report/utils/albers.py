"""
Module for converting WGS_84 lat lon to albers equal area conic
projection based on Snyder (1987), USGS Professional paper 1395
"""
import numpy as np
import geojson


# Constants for projecting to and from Albers
TO_RAD = np.pi / 180.0
SP1 = 0 * TO_RAD
SP2 = 60 * TO_RAD
LON_ORIG = 0 * TO_RAD
