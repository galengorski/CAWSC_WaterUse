...
plt.figure()
plt.scatter(master_pop_df['TPOLYPOP'], master_pop_df['pop_local'])
plt.gca().set_yscale('log')
plt.gca().set_xscale('log')
plt.show()

plt.figure()
v = master_pop_df['pop_swud16']/master_pop_df['WSA_SQKM']
v[v.isna()] = 1
plt.scatter(np.log10(master_pop_df['pop_local']), np.log10(master_pop_df['pop_swud16']),c = np.log10(v) )
plt.colorbar()
plt.show()
