...
def generate_wu_per_capita_spatial_stat(df, max_points=50, raduis=500):
    ...
    for pop_field in ["pop_swud15", "plc_pop_interpolated"]:
        ...
        pc_stat_df.to_csv(
            r"C:\work\water_use\mldataset\ml\training\misc_features\spatial_features\pc_50_{}.csv".format(
                pop_field
            )
        )
    pass
...
if __name__ == "__main__":
    ...
    pop_info = pd.read_csv(
        r"C:\work\water_use\ml_experiments\annual_v_0_0\pop_info.csv"
    )

    # =======================================
    # generate wu per capita stats
    # =======================================
    generate_wu_per_capita_spatial_stat(pop_info, max_points=50, raduis=500)
