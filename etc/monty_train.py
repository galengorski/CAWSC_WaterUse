...
if __name__ == "__main__":
    ...
    wu = pd.read_csv(
        r"C:\work\water_use\mldataset\ml\training\train_datasets\Monthly\wu_monthly_training.csv"
    )
    ...
    if use_normal_xgb:
        ...
        gb = xgb.XGBRegressor(
            ...
            seed=123,
            reg_lambda=0.0,
        )  # tree_method = 'hist',reg_lambda=10,
