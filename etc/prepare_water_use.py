...
def extract_wu_from_nonswud(non_swud_data):
    ...
    monthly_df = non_swud_data.drop(["STATE", 'ANNUAL_MG', 'DATA_FREQ', 'POPULATION',    'FLAG'], axis=1)
...
if __name__ == "__main__":
    ...
    master_pop = pd.read_csv(r"C:\work\water_use\CAWSC_WaterUse\ml_experiments\annual_v_0_0\master_population.csv")
    code_wu_outliers(annual_wu, monthly_wu, master_pop)
