...
if __name__ == "__main__":
    ...
    gmetDC = gmet.DataCollector(folder = r"D:\Workspace\projects\machine_learning\data\dataset\training_data\13")
    start_time = time.time()
    climateData = gmetDC.get_data(shpfile, zoneField, climate_filter=climateFilter,
                    year_filter='2000-2015', multiprocessing= True, chunksize = 20, filter_field= filter_field)
    end_time = time.time()
