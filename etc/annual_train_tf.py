...
# load dataset
df_feat =  pd.read_csv(r"C:\work\water_use\mldataset\ml\training\train_datasets\Annual\wu_annual_training.csv")
...
model.add(Dense(50, activation=act, kernel_initializer='he_normal', input_shape=(n_features,)))
...
# fit the model
history = model.fit(X_train, y_train, epochs=200, batch_size=32, validation_split = 0.1, verbose=2)
