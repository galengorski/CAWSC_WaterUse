...
koppen_climate_df = pd.read_csv(
    r"C:\work\water_use\mldataset\ml\training\misc_features\kg_zones\kg_wsa_zones.csv"
)
...
if add_swud_data:
    ...
    for i, sys_id in enumerate(sys_ids):
        ...
        try:
            pop2 = tot_gb_pop[tot_gb_pop["WSA_AGIDF"] == sys_id]["pop"].values[
                0
            ]
        except:
            print("No pop info")
